...
class TicketPendampingController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn(
                'no_tiket_cell',
                fn($t) =>
                '<span class="adm-mono" style="font-size:12px;white-space:nowrap;">' . e($t->no_tiket) . '</span>'
            )
            ...
            ->addColumn(
                'isi_kendala_cell',
                fn($t) =>
                '<span style="font-size:12.5px;">' . e(Str::limit($t->isi_kendala, 70)) . '</span>'
            )
    ...
    {
        $ticket = TicketPendamping::with(['user.enumerator', 'dataLapangan:id,nama_pu'])
