...
class DataLapangan extends Model
{
     ...
     */
    protected $fillable = ['enumerator_id', 'nama_pu', 'nik', 'telephone', 'rt', 'rw', 'alamat', 'titik_koordinat', 'foto_ktp', 'foto_rumah', 'foto_pendamping', 'foto_proses', 'foto_produk', 'status', 'status_pembayaran', 'file_oss', 'file_sihalal'];
