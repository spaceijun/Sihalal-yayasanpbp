                    ...
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                @foreach ($allProducts as $idx => $prod)
                                    <div class="col-6 col-md-4">
                                        <div class="card border h-100" style="border-radius:10px;overflow:hidden;">
                                            @if (!empty($prod['foto']))
                                                <img src="{{ asset('storage/' . $prod['foto']) }}"
                                                    alt="{{ $prod['nama'] }}"
                                                    style="width:100%;aspect-ratio:4/3;object-fit:cover;cursor:pointer;display:block;"
                                                    onclick="viewFullImage('{{ asset('storage/' . $prod['foto']) }}', 'Foto Produk {{ $idx }}: {{ $prod['nama'] }}')"
                                                    onerror="this.style.display='none';this.nextElementSibling.style.display='flex';">
                                                <div
                                                    style="display:none;width:100%;aspect-ratio:4/3;background:#F1F5F9;align-items:center;justify-content:center;font-size:28px;color:#CBD5E1;">
                                                    <i class="las la-image"></i>
                                                </div>
                                            @else
                                                <div
                                                    style="display:flex;width:100%;aspect-ratio:4/3;background:#F1F5F9;align-items:center;justify-content:center;font-size:28px;color:#CBD5E1;">
                                                    <i class="las la-image"></i>
                                                </div>
                                            @endif
                                            <div class="card-body p-2">
                                                <div class="text-uppercase fw-bold mb-1"
                                                    style="font-size:10px;letter-spacing:.06em;color:var(--vz-primary);">
                                                    Produk {{ $idx }}
                                                </div>
                        ...
                        @else
                            <div class="text-center text-muted py-4" style="font-size:13px;">
                                <i class="las la-box-open d-block mb-2" style="font-size:28px;opacity:.4;"></i>
                        ...
                        @elseif ($entryType == 'SIHALAL')
                            ...
                            <div class="d-flex align-items-center justify-content-between px-4 py-3 border-bottom">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('data-entry.datalapangan.download-foto-pendamping', $dataLapangan->id) }}"
                                        class="btn btn-success btn-sm">
