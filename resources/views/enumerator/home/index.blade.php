...
@section('content')
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        <i class="ri-admin-line"></i> <strong>Selamat datang, Enumerator!</strong>
    ...
    <div class="row">
        ...
        <!-- Tabel 20 Data Revisi -->
        @if ($dataLapanganRevisi->isNotEmpty())
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Data Revisi</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped align-middle mb-0">
                                    ...
                                    <tbody>
                                        @forelse($dataLapanganRevisi as $index => $data)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
