...
@section('content')
                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="{{ route('koordinator.recruitments.create') }}"
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        @include('koordinator.recruitment.partials.table-body')
                                    </tbody>
                                </table>
                            </div>
    ...
    @include('koordinator.recruitment.partials.delete-modal')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // API Base URL
            const API_BASE_URL = '/api/koordinator/recruitments';
