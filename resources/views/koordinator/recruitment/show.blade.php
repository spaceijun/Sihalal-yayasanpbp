        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('koordinator.recruitments.update-status', $recruitment->id) }}"
                            method="POST">
                            @csrf
                            <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('koordinator.recruitments.download-foto', [$recruitment->id, 'foto_diri']) }}"
                        ...
                        <div class="form-group mb-0">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('koordinator.recruitments.download-foto', [$recruitment->id, 'foto_ktp']) }}"
                                        class="btn btn-success btn-sm">
                                        <i class="fas fa-download me-2"></i>Download
                                    </a>
                                </div>
