...
@elseif(auth()->check() && auth()->user()->role === 'data_entry')
    <html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg"
        data-sidebar-image="img-2" data-preloader="disable" data-theme="corporate" data-theme-colors="default">
@elseif(auth()->check() && auth()->user()->role === 'enumerator')
    <html lang="en" data-layout="horizontal" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg"
        data-sidebar-image="img-2" data-preloader="disable" data-theme="default" data-theme-colors="green">
@else
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="#" class="logo logo-dark">
                                <span class="logo-sm">
                                    <span
                                        style="font-size: 14px; font-weight: bold; color: #ffffff;">{{ $settingWebsite->title }}</span>
                                </span>
                                <span class="logo-lg">
                                    <span
                                        style="font-size: 14px; font-weight: bold; color: #ffffff;">{{ $settingWebsite->title }}</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                @elseif (auth()->check() && auth()->user()->role === 'koordinator')
                                    <h6 class="dropdown-header">Welcome
                                        {{ auth()->user()->koordinator->nama_lengkap ?? auth()->user()->name }}!</h6>
                                @endif

                                <form class="dropdown-item" action="{{ route('logout') }}" method="post">
                                    @csrf
                                    <button type="submit" class="btn btn-link p-0 text-start w-100 border-0">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            </script> © {{ $settingWebsite->title }}.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Design & Develop by SwaraningCode
                            </div>
                        </div>
                    </div>
                </div>
