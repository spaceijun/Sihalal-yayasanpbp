...
<head>
    ...
    <style>
        /* Filter bar — spesifik halaman ini, tidak ada di compro-ui.css */
        .filter-bar {
        ...
        .category-chip {
            ...
            font-size: 0.875rem;
            font-weight: 600;
            border: 2px solid rgba(47, 143, 230, 0.15);
            color: var(--kh-text);
            transition: var(--kh-transition);
    ...
    <div class="layout-wrapper landing">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7" data-aos="fade-up" data-aos-duration="800">
                        <div class="hero-badge mb-4 animate-fade-in-up" style="display: inline-flex;">
                            ...
                            <span class="small fw-semibold">Blog & Artikel</span>
                        </div>
                        ...
                        <p class="hero-lead lead mb-0 animate-fade-in-up delay-200"
                            ...
                            Informasi terbaru tentang sertifikasi halal, tips bisnis, dan inspirasi untuk pelaku UMKM.
                        </p>
                    </div>
                </div>
            </div>
                ...
                @if ($articles->isEmpty())
                    <div class="text-center" data-aos="fade-up">
                        <div class="empty-state d-inline-block">
                            ...
                            <h4 class="fw-bold mt-3 mb-2">Belum Ada Artikel</h4>
                                        ...
                                        <div class="col-lg-7">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center gap-2 mb-3">
                                                    ...
                                                    <span class="badge bg-kh-soft text-kh px-2 py-1">
                                                        <i class="ri-star-fill me-1"></i> Artikel Pilihan
                                                    </span>
                                                    <span class="text-muted small"><i
                                                            class="ri-time-line me-1"></i>{{ $first->reading_time ?? 3 }}
                                                        min</span>
                                                </div>
                                                <h3 class="fw-bold mb-3"
                                                    style="font-size: 1.5rem; color: var(--kh-dark); line-height: 1.35;">
                                                    {{ $first->title }}
                                                </h3>
                                                <p class="text-muted mb-4" style="line-height: 1.7;">
                                                    {{ Str::limit($first->excerpt_or_truncated, 160) }}
                                                </p>
                                                <div
                                        ...
                                        <div class="card-body p-4">
                                            <div class="d-flex align-items-center gap-2 mb-3">
                                                ...
                                                <span class="text-muted small">
                                                    <i class="ri-time-line me-1"></i>{{ $article->reading_time ?? 3 }}
                                                    min
                                                </span>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <span class="btn btn-sm btn-kh-outline fw-semibold">
                                                    Baca <i class="ri-arrow-right-line align-bottom ms-1"></i>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="py-5 gradient-kh-dark cta-section position-relative">
            <div class="container position-relative text-center">
                ...
                <h3 class="text-white fw-bold mt-3 mb-2">Ingin Mendapatkan Sertifikat Halal?</h3>
                <p class="text-white text-opacity-75 mb-4">Daftarkan produk Anda sekarang dan dapatkan sertifikat halal
                    dari BPJPH.</p>
