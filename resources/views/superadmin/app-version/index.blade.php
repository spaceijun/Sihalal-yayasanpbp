...
<div class="adm-page">
    ...
    <div class="adm-header">
        ...
        @if ($appVersions->isEmpty())
            <a href="{{ route($routePrefix . '.app-versions.create') }}" class="adm-btn-primary">
                <svg viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                Tambah Versi
            </a>
        @else
            <a href="{{ route($routePrefix . '.app-versions.edit', $appVersions->first()->hashed_id) }}" class="adm-btn-primary adm-btn-success">
