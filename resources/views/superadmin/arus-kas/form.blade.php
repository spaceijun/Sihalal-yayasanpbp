...
<div class="adm-field">
    ...
    <select name="tipe" id="tipe" class="adm-field-select @error('tipe') is-invalid @enderror">
        ...
        <option value="Pengeluaran" {{ old('tipe', $cashflow?->tipe) == 'Pengeluaran' ? 'selected' : '' }}>Pengeluaran
        </option>
...
<div class="adm-field">
    ...
    <input type="date" name="tanggal" id="tanggal" class="adm-input @error('tanggal') is-invalid @enderror"
...
<div class="adm-field">
    ...
    <input type="number" name="jumlah" id="jumlah" class="adm-input @error('jumlah') is-invalid @enderror"
        value="{{ old('jumlah', $cashflow?->jumlah) }}" placeholder="contoh: 500000">
    @error('jumlah')
        <span class="adm-error-msg">{{ $message }}</span>
    @enderror
</div>
...
<div class="adm-field full-span">
    ...
    <textarea name="keterangan" id="keterangan" rows="5"
        class="adm-textarea @error('keterangan') is-invalid @enderror" placeholder="Keterangan transaksi...">{{ old('keterangan', $cashflow?->keterangan) }}</textarea>
    @error('keterangan')
        <span class="adm-error-msg">{{ $message }}</span>
    @enderror
</div>
