...
<div class="adm-page">
    ...
    <div class="adm-header">
        <div class="adm-header-left">
            ...
            <p>Buat artikel baru untuk company profile</p>
        </div>
        ...
        <div class="row">
                ...
                <div class="adm-form-section">
                    ...
                    <div class="adm-form-body">
                        ...
                        <div class="adm-field mt-3">
                            ...
                            <span class="adm-hint">Biarkan kosong untuk generate otomatis</span>
                        </div>

                        <div class="adm-field mt-3">
                            <label for="excerpt" class="adm-label">Excerpt / Ringkasan</label>
                            <textarea class="adm-textarea" id="excerpt" name="excerpt" rows="2"
                                      maxlength="500">{{ old('excerpt') }}</textarea>
                            <span class="adm-hint">Ringkasan singkat untuk tampilan di list (maksimal 500 karakter)</span>
                        </div>

                        <div class="adm-field mt-3">
                            <label for="content" class="adm-label">Konten Artikel <span class="req">*</span></label>
                            <textarea class="adm-textarea" id="content" name="content" rows="15"
            ...
            <div class="col-lg-4">
                ...
                <div class="adm-form-section">
                    ...
                    <div class="adm-form-body">
                        ...
                        <div class="adm-field mt-3">
                            ...
                            <input type="datetime-local" class="adm-input" id="published_at"
                                   name="published_at" value="{{ old('published_at') }}">
                            <span class="adm-hint">Kosongkan untuk publish sekarang</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="adm-form-section">
                    ...
                    <div class="adm-form-body">
                        <div class="adm-field">
                            <label for="image" class="adm-label">Gambar Cover</label>
                            <input type="file" class="adm-input" id="image" name="image" accept="image/*">
                            <span class="adm-hint">Format: JPG, PNG, WebP. Maksimal 5MB</span>
                        </div>
                    </div>
                </div>
