...
<div class="adm-page">
    ...
    <div class="adm-header">
        <div class="adm-header-left">
            <h1>Tambah Data Entry</h1>
            <p>Daftarkan akun petugas data entry baru</p>
        </div>
    ...
    <div class="adm-form-section">
        ...
        <form method="POST" action="{{ route('superadmin.data-entries.store') }}" enctype="multipart/form-data">
            @csrf
