                    ...
                    <div class="adm-filter-group">
                        ...
                        <select id="status_pembayaran" name="status_pembayaran" class="adm-select">
                            ...
                            <option value="PENDING" {{ request('status_pembayaran') == 'PENDING' ? 'selected' : '' }}>
                                Pending</option>
                            <option value="PENGAJUAN" {{ request('status_pembayaran') == 'PENGAJUAN' ? 'selected' : '' }}>
                                Pengajuan</option>
                            <option value="DIBAYAR" {{ request('status_pembayaran') == 'DIBAYAR' ? 'selected' : '' }}>
                                Dibayar</option>
                        </select>
                    </div>
                    <div class="adm-filter-group">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            exportBtn.addEventListener('click', function() {
                ...
                if (tanggalSampaiInput.value.trim()) params.append('tanggal_sampai', tanggalSampaiInput
                    .value.trim());
                window.location.href = '{{ route('superadmin.data-lapangans.export') }}' + (params
