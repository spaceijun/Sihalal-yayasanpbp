            ...
            <div class="col">
                <div class="card card-animate">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('superadmin.enumerators.show', $enumerator->id) }}">
                            ← Back
                        </a>
                    </div>
                                            ...
                                            <div class="col-6 col-md-3 col-lg-2">
                                                <div class="card h-100 border shadow-sm">
                                                    ...
                                                    <div class="position-relative" style="cursor:pointer;"
                                                        ...
                                                        '{{ $data->nama_produk ?? '-' }}',
                                                        '{{ $data->status }}',
                                                        '{{ route('superadmin.enumerators.download-foto-entry', [$enumerator->id, $data->id, 'foto_pendamping']) }}')">
                                                    ...
                                                    <div class="card-body p-2">
                                                        ...
                                                        {{ $data->status === 'Terverifikasi'
                                                            ...
                                                            {{-- Tombol Download --}}
                                                            <a href="{{ route('superadmin.enumerators.download-foto-entry', [$enumerator->id, $data->id, 'foto_pendamping']) }}"
