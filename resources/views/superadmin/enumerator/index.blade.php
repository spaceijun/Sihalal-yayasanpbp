    ...
    <div class="adm-page">
        ...
        <div class="adm-header">
            ...
            <div style="display:flex;gap:8px;align-items:center;">
                {{-- Tombol Export PDF --}}
                <a id="exportPdfBtn" href="{{ route('superadmin.enumerators.export-pdf') }}" class="adm-btn-secondary"
                ...
                <div class="modal-body" style="padding:20px 24px;">
                    ...
                    <div class="adm-info-list" style="border:none;">
                        ...
                        <div class="adm-info-row">
                            ...
                            <span class="adm-info-val"><code
                                    style="background:var(--adm-blue-lt);color:var(--adm-blue);padding:2px 8px;border-radius:4px;font-size:12px;">enumkh123</code></span>
                        </div>
                        <div class="adm-info-row">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function syncExportUrl() {
                ...
                if (searchInput.value.trim()) params.append('search', searchInput.value.trim());
                if (statusSelect.value.trim()) params.append('status', statusSelect.value.trim());
                const base = '{{ route('superadmin.enumerators.export-pdf') }}';
                document.getElementById('exportPdfBtn').href = base + (params.toString() ? '?' + params : '');
            }
            searchInput.addEventListener('input', syncExportUrl);
            statusSelect.addEventListener('change', syncExportUrl);
            resetBtn.addEventListener('click', () => setTimeout(syncExportUrl, 50));
            syncExportUrl();
            ...
            confirmDeleteBtn.addEventListener('click', function() {
                ...
                fetch(`${API_BASE_URL}/${deleteEnumeratorId}`, {
                    ...
                    .finally(() => {
                        ...
                        confirmDeleteBtn.innerHTML =
                            '<svg viewBox="0 0 24 24" style="width:16px;height:16px;stroke:currentColor;fill:none;stroke-width:2;"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/></svg> Hapus Data';
            ...
            function attachGenerateUserHandlers() {
                document.querySelectorAll('.btn-generate-user').forEach(btn => {
                    ...
                    nb.addEventListener('click', function() {
                        ...
                        document.getElementById('generateUserEmail').textContent = this.dataset.hp +
                            '@kawulohalal.id';
