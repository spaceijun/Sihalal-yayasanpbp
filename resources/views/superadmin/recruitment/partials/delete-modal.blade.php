...
<div class="modal fade adm-modal" id="deleteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align:center;padding:28px 24px 20px;">
                ...
                <h5 style="font-family:'Sora',sans-serif;font-weight:700;color:var(--adm-text-dark);margin-bottom:8px;">Yakin hapus data recruitment ini?</h5>
                <p style="font-size:13px;color:var(--adm-text-muted);margin:0;">Data yang telah dihapus tidak dapat dikembalikan lagi.</p>
            </div>
