...
<div class="adm-page">
    ...
    <div class="adm-header">
        ...
        <a href="{{ route('superadmin.spotchecks.create') }}" class="adm-btn-primary">
                            ...
                            <td class="tc">
                                <div class="adm-actions" style="justify-content:center;gap:4px;">
                                    <a class="adm-btn primary icon-only"
                                        href="{{ route('superadmin.spotchecks.show', $spotcheck->hashed_id) }}" title="Lihat">
                                        <svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                    </a>
                                    <a class="adm-btn warning icon-only"
                                        href="{{ route('superadmin.spotchecks.edit', $spotcheck->hashed_id) }}" title="Edit">
                                        <svg viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                                    </a>
                                    <form action="{{ route('superadmin.spotchecks.destroy', $spotcheck->hashed_id) }}" method="POST" class="d-inline">
                                        @csrf @method('DELETE')
