...
<div class="adm-page">
    ...
    <div class="adm-form-section">
        ...
        <form method="POST" action="{{ route($routePrefix . '.verifikators.update', $verifikator->hashed_id) }}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="adm-form-actions">
                ...
                <a href="{{ route($routePrefix . '.verifikators.index') }}" class="adm-btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
